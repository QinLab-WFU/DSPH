...
if __name__ == "__main__":
    ...
    parser.add_argument("--coco-dir", default="/home/admin00/dataset/coco/archive (1)/coco2017", type=str, help="the coco dataset dir")
    ...
    scio.savemat("/home/admin00/DSPH-main/dataset/coco/index.mat", indexs)
    scio.savemat("/home/admin00/DSPH-main/dataset/coco/caption.mat", captions)
    scio.savemat("/home/admin00/DSPH-main/dataset/coco/label.mat", categorys)
